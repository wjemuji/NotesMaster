 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function o$3(o){return (e,n)=>{const{slot:r,selector:s}=o??{},c="slot"+(r?`[name=${r}]`:":not([name])");return e$6(e,n,{get(){const t=this.renderRoot?.querySelector(c),e=t?.assignedElements(o)??[];return undefined===s?e:e.filter((t=>t.matches(s)))}})}}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1=globalThis,i$2=t$1.trustedTypes,s$2=i$2?i$2.createPolicy("lit-html",{createHTML:t=>t}):undefined,e$3="$lit$",h=`lit$${(Math.random()+"").slice(9)}$`,o$2="?"+h,n$3=`<${o$2}>`,r$1=document,l$2=()=>r$1.createComment(""),c=t=>null===t||"object"!=typeof t&&"function"!=typeof t,a$1=Array.isArray,u$1=t=>a$1(t)||"function"==typeof t?.[Symbol.iterator],d="[ \t\n\f\r]",f$1=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,v=/-->/g,_=/>/g,m$1=RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),p=/'/g,g=/"/g,$=/^(?:script|style|textarea|title)$/i,y=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x=y(1),w=Symbol.for("lit-noChange"),T=Symbol.for("lit-nothing"),A=new WeakMap,E=r$1.createTreeWalker(r$1,129);function C(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return undefined!==s$2?s$2.createHTML(i):i}const P=(t,i)=>{const s=t.length-1,o=[];let r,l=2===i?"<svg>":"",c=f$1;for(let i=0;i<s;i++){const s=t[i];let a,u,d=-1,y=0;for(;y<s.length&&(c.lastIndex=y,u=c.exec(s),null!==u);)y=c.lastIndex,c===f$1?"!--"===u[1]?c=v:undefined!==u[1]?c=_:undefined!==u[2]?($.test(u[2])&&(r=RegExp("</"+u[2],"g")),c=m$1):undefined!==u[3]&&(c=m$1):c===m$1?">"===u[0]?(c=r??f$1,d=-1):undefined===u[1]?d=-2:(d=c.lastIndex-u[2].length,a=u[1],c=undefined===u[3]?m$1:'"'===u[3]?g:p):c===g||c===p?c=m$1:c===v||c===_?c=f$1:(c=m$1,r=undefined);const x=c===m$1&&t[i+1].startsWith("/>")?" ":"";l+=c===f$1?s+n$3:d>=0?(o.push(a),s.slice(0,d)+e$3+s.slice(d)+h+x):s+h+(-2===d?i:x);}return [C(t,l+(t[s]||"<?>")+(2===i?"</svg>":"")),o]};class V{constructor({strings:t,_$litType$:s},n){let r;this.parts=[];let c=0,a=0;const u=t.length-1,d=this.parts,[f,v]=P(t,s);if(this.el=V.createElement(f,n),E.currentNode=this.el.content,2===s){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes);}for(;null!==(r=E.nextNode())&&d.length<u;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(e$3)){const i=v[a++],s=r.getAttribute(t).split(h),e=/([.?@])?(.*)/.exec(i);d.push({type:1,index:c,name:e[2],strings:s,ctor:"."===e[1]?k:"?"===e[1]?H:"@"===e[1]?I:R}),r.removeAttribute(t);}else t.startsWith(h)&&(d.push({type:6,index:c}),r.removeAttribute(t));if($.test(r.tagName)){const t=r.textContent.split(h),s=t.length-1;if(s>0){r.textContent=i$2?i$2.emptyScript:"";for(let i=0;i<s;i++)r.append(t[i],l$2()),E.nextNode(),d.push({type:2,index:++c});r.append(t[s],l$2());}}}else if(8===r.nodeType)if(r.data===o$2)d.push({type:2,index:c});else {let t=-1;for(;-1!==(t=r.data.indexOf(h,t+1));)d.push({type:7,index:c}),t+=h.length-1;}c++;}}static createElement(t,i){const s=r$1.createElement("template");return s.innerHTML=t,s}}function N(t,i,s=t,e){if(i===w)return i;let h=undefined!==e?s._$Co?.[e]:s._$Cl;const o=c(i)?undefined:i._$litDirective$;return h?.constructor!==o&&(h?._$AO?.(false),undefined===o?h=undefined:(h=new o(t),h._$AT(t,s,e)),undefined!==e?(s._$Co??=[])[e]=h:s._$Cl=h),undefined!==h&&(i=N(t,h._$AS(t,i.values),h,e)),i}class S{constructor(t,i){this._$AV=[],this._$AN=undefined,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:s}=this._$AD,e=(t?.creationScope??r$1).importNode(i,true);E.currentNode=e;let h=E.nextNode(),o=0,n=0,l=s[0];for(;undefined!==l;){if(o===l.index){let i;2===l.type?i=new M(h,h.nextSibling,this,t):1===l.type?i=new l.ctor(h,l.name,l.strings,this,t):6===l.type&&(i=new L(h,this,t)),this._$AV.push(i),l=s[++n];}o!==l?.index&&(h=E.nextNode(),o++);}return E.currentNode=r$1,e}p(t){let i=0;for(const s of this._$AV) undefined!==s&&(undefined!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}}class M{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,s,e){this.type=2,this._$AH=T,this._$AN=undefined,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cv=e?.isConnected??true;}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return undefined!==i&&11===t?.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=N(this,t,i),c(t)?t===T||null==t||""===t?(this._$AH!==T&&this._$AR(),this._$AH=T):t!==this._$AH&&t!==w&&this._(t):undefined!==t._$litType$?this.g(t):undefined!==t.nodeType?this.$(t):u$1(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==T&&c(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$1.createTextNode(t)),this._$AH=t;}g(t){const{values:i,_$litType$:s}=t,e="number"==typeof s?this._$AC(t):(undefined===s.el&&(s.el=V.createElement(C(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===e)this._$AH.p(i);else {const t=new S(e,this),s=t.u(this.options);t.p(i),this.$(s),this._$AH=t;}}_$AC(t){let i=A.get(t.strings);return undefined===i&&A.set(t.strings,i=new V(t)),i}T(t){a$1(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const h of t)e===i.length?i.push(s=new M(this.k(l$2()),this.k(l$2()),this,this.options)):s=i[e],s._$AI(h),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(false,true,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){ undefined===this._$AM&&(this._$Cv=t,this._$AP?.(t));}}class R{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,e,h){this.type=1,this._$AH=T,this._$AN=undefined,this.element=t,this.name=i,this._$AM=e,this.options=h,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=T;}_$AI(t,i=this,s,e){const h=this.strings;let o=false;if(undefined===h)t=N(this,t,i,0),o=!c(t)||t!==this._$AH&&t!==w,o&&(this._$AH=t);else {const e=t;let n,r;for(t=h[0],n=0;n<h.length-1;n++)r=N(this,e[s+n],i,n),r===w&&(r=this._$AH[n]),o||=!c(r)||r!==this._$AH[n],r===T?t=T:t!==T&&(t+=(r??"")+h[n+1]),this._$AH[n]=r;}o&&!e&&this.j(t);}j(t){t===T?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"");}}class k extends R{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===T?undefined:t;}}class H extends R{constructor(){super(...arguments),this.type=4;}j(t){this.element.toggleAttribute(this.name,!!t&&t!==T);}}class I extends R{constructor(t,i,s,e,h){super(t,i,s,e,h),this.type=5;}_$AI(t,i=this){if((t=N(this,t,i,0)??T)===w)return;const s=this._$AH,e=t===T&&s!==T||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,h=t!==T&&(s===T||e);e&&this.element.removeEventListener(this.name,this,s),h&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t);}}class L{constructor(t,i,s){this.element=t,this.type=6,this._$AN=undefined,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){N(this,t);}}const Z=t$1.litHtmlPolyfillSupport;Z?.(V,M),(t$1.litHtmlVersions??=[]).push("3.0.0");const j=(t,i,s)=>{const e=s?.renderBefore??i;let h=e._$litPart$;if(undefined===h){const t=s?.renderBefore??null;e._$litPart$=h=new M(i.insertBefore(l$2(),t),t,undefined,s??{});}return h._$AI(t),h};

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let s$1 = class s extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=undefined;}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=j(i,this.renderRoot,this.renderOptions);}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(true);}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(false);}render(){return w}};s$1._$litElement$=true,s$1[("finalized")]=true,globalThis.litElementHydrateSupport?.({LitElement:s$1});const r=globalThis.litElementPolyfillSupport;r?.({LitElement:s$1});(globalThis.litElementVersions??=[]).push("4.0.0");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const e$1=e$2(class extends i$1{constructor(t$1){if(super(t$1),t$1.type!==t.ATTRIBUTE||"class"!==t$1.name||t$1.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return " "+Object.keys(t).filter((s=>t[s])).join(" ")+" "}update(s,[i]){if(undefined===this.it){this.it=new Set,undefined!==s.strings&&(this.st=new Set(s.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in i)i[t]&&!this.st?.has(t)&&this.it.add(t);return this.render(i)}const r=s.element.classList;for(const t of this.it)t in i||(r.remove(t),this.it.delete(t));for(const t in i){const s=!!i[t];s===this.it.has(t)||this.st?.has(t)||(s?(r.add(t),this.it.add(t)):(r.remove(t),this.it.delete(t)));}return w}});
...
__decorate([
    n$5({ type: Boolean, reflect: true })
], Chip.prototype, "disabled", undefined);
__decorate([
    n$5({ type: Boolean, attribute: 'always-focusable' })
], Chip.prototype, "alwaysFocusable", undefined);
__decorate([
    n$5()
], Chip.prototype, "label", undefined);
__decorate([
    n$5({ type: Boolean, reflect: true, attribute: 'has-icon' })
], Chip.prototype, "hasIcon", undefined);
...
__decorate([
    n$5({ type: Boolean })
], AssistChip.prototype, "elevated", undefined);
__decorate([
    n$5()
], AssistChip.prototype, "href", undefined);
__decorate([
    n$5()
], AssistChip.prototype, "target", undefined);
...
__decorate([
    o$3()
], ChipSet.prototype, "childElements", undefined);
...
__decorate([
    n$5({ type: Boolean })
], FilterChip.prototype, "elevated", undefined);
__decorate([
    n$5({ type: Boolean })
], FilterChip.prototype, "removable", undefined);
__decorate([
    n$5({ type: Boolean, reflect: true })
], FilterChip.prototype, "selected", undefined);
__decorate([
    n$5({ type: Boolean, reflect: true, attribute: 'has-selected-icon' })
], FilterChip.prototype, "hasSelectedIcon", undefined);
__decorate([
    e$5('.primary.action')
], FilterChip.prototype, "primaryAction", undefined);
__decorate([
    e$5('.trailing.action')
], FilterChip.prototype, "trailingAction", undefined);
...
__decorate([
    n$5({ type: Boolean })
], InputChip.prototype, "avatar", undefined);
__decorate([
    n$5()
], InputChip.prototype, "href", undefined);
__decorate([
    n$5()
], InputChip.prototype, "target", undefined);
__decorate([
    n$5({ type: Boolean, attribute: 'remove-only' })
], InputChip.prototype, "removeOnly", undefined);
__decorate([
    n$5({ type: Boolean, reflect: true })
], InputChip.prototype, "selected", undefined);
__decorate([
    e$5('.trailing.action')
], InputChip.prototype, "trailingAction", undefined);
...
__decorate([
    n$5({ type: Boolean })
], Dialog.prototype, "quick", undefined);
__decorate([
    n$5({ attribute: false })
...
__decorate([
    n$5({ reflect: true })
], SharedFab.prototype, "size", undefined);
__decorate([
    n$5()
], SharedFab.prototype, "label", undefined);
__decorate([
    n$5({ type: Boolean })
], SharedFab.prototype, "lowered", undefined);
...
__decorate([
    n$5()
], Fab.prototype, "variant", undefined);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const e=Symbol.for(""),o$1=t=>{if(t?.r===e)return t?._$litStatic$},s=(t,...r)=>({_$litStatic$:r.reduce(((r,e,o)=>r+(t=>{if(undefined!==t._$litStatic$)return t._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(e)+t[o+1]),t[0]),r:e}),a=new Map,l$1=t=>(r,...e)=>{const i=e.length;let s,l;const n=[],u=[];let c,$=0,f=false;for(;$<i;){for(c=r[$];$<i&&undefined!==(l=e[$],s=o$1(l));)c+=s+r[++$],f=true;$!==i&&u.push(l),n.push(c),$++;}if($===i&&n.push(r[i]),f){const t=n.join("$$lit$$");undefined===(r=a.get(t))&&(n.raw=n,a.set(t,r=n)),e=u;}return t(r,...e)},n$2=l$1(x);
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const n$1="important",i=" !"+n$1,o=e$2(class extends i$1{constructor(t$1){if(super(t$1),t$1.type!==t.ATTRIBUTE||"style"!==t$1.name||t$1.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,r)=>{const s=t[r];return null==s?e:e+`${r=r.includes("-")?r:r.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(e,[r]){const{style:s}=e.element;if(undefined===this.ut)return this.ut=new Set(Object.keys(r)),this.render(r);for(const t of this.ut)null==r[t]&&(this.ut.delete(t),t.includes("-")?s.removeProperty(t):s[t]=null);for(const t in r){const e=r[t];if(null!=e){this.ut.add(t);const r="string"==typeof e&&e.endsWith(i);t.includes("-")||r?s.setProperty(t,r?e.slice(0,-11):e,r?n$1:""):s[t]=e;}}return w}});
...
], Menu.prototype, "noNavigationWrap", undefined);
__decorate([
    o$3({ flatten: true })
...
__decorate([
    n$5({ type: Boolean, reflect: true })
], MenuItemEl.prototype, "disabled", undefined);
__decorate([
    n$5()
], MenuItemEl.prototype, "type", undefined);
__decorate([
    n$5()
], MenuItemEl.prototype, "href", undefined);
__decorate([
    n$5()
], MenuItemEl.prototype, "target", undefined);
__decorate([
    n$5({ type: Boolean, attribute: 'keep-open' })
], MenuItemEl.prototype, "keepOpen", undefined);
__decorate([
    n$5({ type: Boolean })
], MenuItemEl.prototype, "selected", undefined);
__decorate([
    e$5('.list-item')
], MenuItemEl.prototype, "listItemRoot", undefined);
__decorate([
    o$3({ slot: 'headline' })
], MenuItemEl.prototype, "headlineElements", undefined);
__decorate([
    o$3({ slot: 'supporting-text' })
], MenuItemEl.prototype, "supportingTextElements", undefined);
__decorate([
    n$4({ slot: '' })
], MenuItemEl.prototype, "defaultElements", undefined);
__decorate([
...
__decorate([
    n$5({ attribute: 'anchor-corner' })
], SubMenu.prototype, "anchorCorner", undefined);
__decorate([
    n$5({ attribute: 'menu-corner' })
], SubMenu.prototype, "menuCorner", undefined);
__decorate([
    n$5({ type: Number, attribute: 'hover-open-delay' })
], SubMenu.prototype, "hoverOpenDelay", undefined);
__decorate([
    n$5({ type: Number, attribute: 'hover-close-delay' })
], SubMenu.prototype, "hoverCloseDelay", undefined);
__decorate([
    n$5({ type: Boolean, reflect: true, attribute: 'md-sub-menu' })
], SubMenu.prototype, "isSubMenu", undefined);
__decorate([
    o$3({ slot: 'item', flatten: true })
], SubMenu.prototype, "items", undefined);
__decorate([
    o$3({ slot: 'menu', flatten: true })
], SubMenu.prototype, "menus", undefined);
...
__decorate([
    n$5({ type: Number })
], LinearProgress.prototype, "buffer", undefined);
...
function mixinFocusable(base) {
    ...
    __decorate([
        n$5({ noAccessor: true })
    ], FocusableElement.prototype, "tabIndex", undefined);
...
__decorate([
    n$5({ type: Boolean })
], Radio.prototype, "required", undefined);
__decorate([
    n$5()
], Radio.prototype, "value", undefined);
__decorate([
    e$5('.container')
], Radio.prototype, "container", undefined);
...
], Select.prototype, "clampMenuWidth", undefined);
__decorate([
    n$5({ type: Number, attribute: 'typeahead-delay' })
...
], Select.prototype, "menuAlign", undefined);
__decorate([
    n$5()
...
__decorate([
    r$4()
], Select.prototype, "defaultFocus", undefined);
__decorate([
    e$5('.field')
...
__decorate([
    o$3({ slot: 'supporting-text' })
], SelectOptionEl.prototype, "supportingTextElements", undefined);
__decorate([
    n$4({ slot: '' })
], SelectOptionEl.prototype, "defaultElements", undefined);
__decorate([
    n$5({ attribute: 'typeahead-text' })
...
__decorate([
    n$5({ type: Number })
], Slider.prototype, "value", undefined);
__decorate([
    n$5({ type: Number, attribute: 'value-start' })
], Slider.prototype, "valueStart", undefined);
__decorate([
    n$5({ type: Number, attribute: 'value-end' })
], Slider.prototype, "valueEnd", undefined);
__decorate([
    n$5({ attribute: 'value-label' })
], Slider.prototype, "valueLabel", undefined);
__decorate([
    n$5({ attribute: 'value-label-start' })
], Slider.prototype, "valueLabelStart", undefined);
__decorate([
    n$5({ attribute: 'value-label-end' })
], Slider.prototype, "valueLabelEnd", undefined);
__decorate([
    n$5({ attribute: 'aria-label-start' })
], Slider.prototype, "ariaLabelStart", undefined);
__decorate([
    n$5({ attribute: 'aria-valuetext-start' })
], Slider.prototype, "ariaValueTextStart", undefined);
__decorate([
    n$5({ attribute: 'aria-label-end' })
], Slider.prototype, "ariaLabelEnd", undefined);
__decorate([
    n$5({ attribute: 'aria-valuetext-end' })
], Slider.prototype, "ariaValueTextEnd", undefined);
__decorate([
    n$5({ type: Number })
], Slider.prototype, "step", undefined);
__decorate([
    n$5({ type: Boolean })
], Slider.prototype, "ticks", undefined);
__decorate([
    n$5({ type: Boolean })
], Slider.prototype, "labeled", undefined);
__decorate([
    n$5({ type: Boolean })
], Slider.prototype, "range", undefined);
__decorate([
    e$5('input.start')
], Slider.prototype, "inputStart", undefined);
__decorate([
    e$5('.handle.start')
], Slider.prototype, "handleStart", undefined);
__decorate([
    r$2('md-ripple.start')
], Slider.prototype, "rippleStart", undefined);
__decorate([
    e$5('input.end')
], Slider.prototype, "inputEnd", undefined);
__decorate([
    e$5('.handle.end')
], Slider.prototype, "handleEnd", undefined);
__decorate([
    r$2('md-ripple.end')
], Slider.prototype, "rippleEnd", undefined);
__decorate([
    r$4()
], Slider.prototype, "handleStartHover", undefined);
__decorate([
    r$4()
], Slider.prototype, "handleEndHover", undefined);
__decorate([
    r$4()
], Slider.prototype, "startOnTop", undefined);
__decorate([
    r$4()
], Slider.prototype, "handlesOverlapping", undefined);
__decorate([
    r$4()
], Slider.prototype, "renderValueStart", undefined);
__decorate([
    r$4()
], Slider.prototype, "renderValueEnd", undefined);
...
__decorate([
    n$5({ type: Boolean })
], Switch.prototype, "selected", undefined);
__decorate([
    n$5({ type: Boolean })
], Switch.prototype, "icons", undefined);
__decorate([
    n$5({ type: Boolean, attribute: 'show-only-selected-icon' })
], Switch.prototype, "showOnlySelectedIcon", undefined);
__decorate([
    n$5({ type: Boolean })
], Switch.prototype, "required", undefined);
__decorate([
    n$5()
], Switch.prototype, "value", undefined);
__decorate([
    e$5('input')
], Switch.prototype, "input", undefined);
...
__decorate([
    e$5('.tabs')
], Tabs.prototype, "tabsScrollerElement", undefined);
__decorate([
    e$5('slot')
